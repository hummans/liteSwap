...
import { CardSection, Break } from '../earn/styled';
      ...
      {!attempting && (
        <ContentWrapper gap="lg">
          <div>
            ...
            <CardSection gap="md">
              <RowBetween>
                <TYPE.white fontWeight={500}>Claim LUCK Token</TYPE.white>
                <CloseIcon onClick={wrappedOnDismiss} style={{ zIndex: 99 }} stroke="white" />
              </RowBetween>
              <TYPE.white fontWeight={700} fontSize={36}>
                {unclaimedAmount?.toFixed(0, { groupSeparator: ',' } ?? '-')} LUCK
              </TYPE.white>
            </CardSection>
            <Break />
          </div>
          <AutoColumn gap="md" style={{ padding: '1rem', paddingTop: '0' }} justify="center">
            <TYPE.subHeader fontWeight={500}>
              Enter an address to trigger a LUCK claim. If the address has any claimable LUCK it will be sent to them on
              submission.
            </TYPE.subHeader>
        ...
        <ConfirmOrLoadingWrapper>
          ...
          <AutoColumn gap="100px" justify={'center'}>
            <AutoColumn gap="12px" justify={'center'}>
              ...
              {!claimConfirmed && (
                <Text fontSize={36} color={'#E15353'} fontWeight={800}>
                  {unclaimedAmount?.toFixed(0, { groupSeparator: ',' } ?? '-')} LUCK
                </Text>
              )}
              {parsedAddress && (
